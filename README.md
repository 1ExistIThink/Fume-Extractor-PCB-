...
Example Calculations: 
    ...
    `V4 = 13.2V, V3 = 14.0V, V2 = 15.0V, V1 = 16.0V, scaled down to 12V my multiplying by 0.7143, V4 = 9.43V, V3 = 10.00V, V2 = 10.71V, V1 = 11.43V` (ex: 9.43V is equivilent to 13.2V so the battery is fully dead below 9.43V)
    ...
    12V Ladder: `VR1 = 12.0 - 11.43 = 0.57V, VR2 = 11.43 - 10.71 = 0.72V, VR3 = 10.71 - 10.00 = 0.71V, VR4 = 10.00 - 9.43 = 0.57V, VR5 = 9.43 - 0 = 9.43V`
    
    Therefore since the current through all resistors is the same:
    
    12V ladder: `R1​:R2​:R3​:R4​:R5​ = 0.57:0.72:0.71:0.57:9.43` -> normalize by R/0.57 -> `R1:R2:R3:R4:R5 = 1:1.26:1.25:1:16.54`
